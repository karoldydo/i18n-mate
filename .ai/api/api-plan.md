...
[See details →](./endpoints/2.1-authentication-signup.md)

Register new user account. Sends verification email. No session created until email verified.

### 2.2 Resend Verification Email

[See details →](./endpoints/2.2-authentication-resend-verification.md)

Resend verification email for unverified accounts.

### 2.3 Verify Email

[See details →](./endpoints/2.3-authentication-verify-email.md)

Verify email using token from verification email.

### 2.4 Sign In

[See details →](./endpoints/2.4-authentication-signin.md)

Login with email and password. Requires verified email.

### 2.5 Sign Out

[See details →](./endpoints/2.5-authentication-signout.md)

Invalidate current session.

### 2.6 Request Password Reset

[See details →](./endpoints/2.6-authentication-request-password-reset.md)

Send password reset link to user email.

### 2.7 Reset Password

[See details →](./endpoints/2.7-authentication-reset-password.md)
...
[See details →](./endpoints/5.1-keys-list-default-view.md)
...
[See details →](./endpoints/6.1-translations-get.md)

Get single translation record.

### 6.2 Update Translation (Inline Edit)

[See details →](./endpoints/6.2-translations-update.md)

Update translation value (autosave). Updates metadata.

### 6.3 Bulk Update Translations

[See details →](./endpoints/6.3-translations-bulk-update.md)
...
[See details →](./endpoints/7.1-translation-jobs-check-active.md)

Check if project has active translation job.

### 7.2 List Translation Jobs

[See details →](./endpoints/7.2-translation-jobs-list.md)

Get translation job history for project.

### 7.3 Create Translation Job

[See details →](./endpoints/7.3-translation-jobs-create.md)

Create and execute LLM translation job (Supabase Edge Function).

### 7.4 Cancel Translation Job

[See details →](./endpoints/7.4-translation-jobs-cancel.md)

Cancel running translation job.

### 7.5 Get Job Items

[See details →](./endpoints/7.5-translation-jobs-get-items.md)
...
[See details →](./endpoints/8.1-export-translations.md)
...
[See details →](./endpoints/9.1-telemetry-get.md)

Get telemetry events for project (owner or service_role only).

### 9.2 Create Telemetry Event

[See details →](./endpoints/9.2-telemetry-create.md)

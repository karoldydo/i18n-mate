-- =====================================================================
-- migration: fix ambiguous 'id' column reference in create_project_locale_atomic
-- description: Explicitly qualify id column in DELETE and SELECT statements
-- problem: "column reference \"id\" is ambiguous" error during locale creation
-- solution: Use table alias in all column references
-- =====================================================================
...
BEGIN
  ...
  -- Return the created locale (explicitly qualify all columns)
  RETURN QUERY
  SELECT
    pl.id,
    pl.project_id,
